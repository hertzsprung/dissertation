...
The time derivative is solved implicitly using a backward-in-time, second order accurate scheme.  At time level $n$, the time derivative, $\partial \varphi / \partial t$, is \autocite{openfoam-progguide}
\begin{align}
