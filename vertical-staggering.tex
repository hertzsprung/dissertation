...
\node at (7,1) {$1$};
\draw (0,1) -- (6,1) node [at start, anchor=east] {$u, v, \theta, \rho$};
\draw (8,1) -- (14,1) node [at end, anchor=west] {$u, v, \rho$};
...
\node at (7,3) {$2$};
\draw (0,3) -- (6,3) node [at start, anchor=east] {$u, v, \theta, \rho$};
\draw (8,3) -- (14,3) node [at end, anchor=west] {$u, v, \rho$};
...
\node at (7,6) {$j - \frac{1}{2}$};
\draw [dashed] (0,6) -- (6,6) node [at start, anchor=east] {$w$};
\draw [dashed] (8,6) -- (14,6) node [at end, anchor=west] {$\theta, w$};

\node at (7,7) {$j$};
\draw (0,7) -- (6,7) node [at start, anchor=east] {$u, v, \theta, \rho$};
\draw (8,7) -- (14,7) node [at end, anchor=west] {$u, v, \rho$};

\node at (7,8) {$j + \frac{1}{2}$};
\draw [dashed] (0,8) -- (6,8) node [at start, anchor=east] {$w$};
\draw [dashed] (8,8) -- (14,8) node [at end, anchor=west] {$\theta, w$};

\node at (7,9) {$j + 1$};
\draw (0,9) -- (6,9) node [at start, anchor=east] {$u, v, \theta, \rho$};
\draw (8,9) -- (14,9) node [at end, anchor=west] {$u, v, \rho$};

\node at (7,10) {$j + \frac{3}{2}$};
