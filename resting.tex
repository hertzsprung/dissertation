...
An analytic solution would conserve total energy such that $\Delta E(t) = 0\;\forall\;t$.   \TODO{why would we expect our model to lose energy?}
...
\begin{figure}
	...
	\\
	\subcaptionbox{BTF}[0.32\textwidth]{\input{resting-energy-btf-plot}}
	\hfill
	\subcaptionbox{Optimised SLEVE}[0.32\textwidth]{\input{resting-energy-sleve-plot}}
	\hfill
	\subcaptionbox{SnapCol (note different vertical scale from other plots)}[0.32\textwidth]{\input{resting-energy-snapCol-plot}}
	\caption{\TODO{Normalised energy changes}}
	\label{fig:resting:energy}
\end{figure}

Examining normalised energy change, shown in figure~\ref{fig:resting:energy:total}, we find that energy is lost on BTF and optimised SLEVE grids.  Energy is better conserved on the SnapCol grid, the energy loss being more than two orders of magnitude smaller than the terrain following grids.  Energy
