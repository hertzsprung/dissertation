...
This two-dimensional test simulates a stably stratified atmosphere in hydrostatic balance.  Since there are no net forces, the analytic solution should remain at rest.  The test specification follows that from \textcite{klemp2011}, and challenges the accuracy of the calculation of the horizontal pressure gradient.  \TODO{but we are not calculating a horizontal pressure gradient.  So what is the challenge?} An inversion layer causes nonlinear processes that further tax the model \autocite{good2013}.
...
\TODO{final conclusions from this test}
