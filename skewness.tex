...
\begin{figure}
	...
	\centering
	\subcaptionbox{Orthogonal grid \label{fig:theory:skewness:ortho}}[0.49\textwidth]{\input{skewOrtho}\vspace{1em}}
	\hfill
	\subcaptionbox{Non-orthogonal grid \label{fig:theory:skewness:nonortho}}[0.49\textwidth]{\input{skewNonOrtho}}
%
