...
\begin{figure}
	...
	\caption{Vertical profiles of the Exner function of pressure, $\exner$, and potential temperature, $\theta$ in the lowest \SI{1}{\kilo\meter} in the lee of the mountain at $x = \SI{50}{\kilo\meter}$ after 5 hours.  The computational mode is manifested as a slight zig-zag in potential temperature on the SnapCol grid.}
