...
%
	...
	\hfill
	\subcaptionbox{SnapCol $h_0 = \SI{500}{\meter}$ \label{fig:gw:div:snapCol-dh}}[0.49\textwidth]{\includegraphics[width=1.8in,angle=270]{data/gravityWaves-snapCol-schaerExp-h/18000/divUf.eps}} \\
%
	\includegraphics[height=5in,angle=270]{legends/divU.eps}
%
	\caption{Divergence (\si{\per\second}) of the discrete velocity field in the centremost \SI{20}{\kilo\meter} and lowest \SI{8}{\kilo\meter} on \TODO{grids and mountain heights}}
	\label{fig:gw:div}
\end{figure}
