...
\begin{figure}
	...
	\hfill
	\subcaptionbox{SLEVE}[0.48\textwidth]{\hspace{0.2in}\includegraphics[height=2.6in,angle=270]{data/gravityWaves-sleve-schaerExp-h/18000/w.eps}} \\
	\subcaptionbox{SnapCol}[0.48\textwidth]{\vspace{0.1in}\includegraphics[height=2.6in,angle=270]{data/gravityWaves-snapCol-schaerExp-h/18000/w.eps}}
	\hfill
