...
\begin{figure}
	...
	\subcaptionbox{SLEVE DH \label{fig:gw:thetaDiffZoom:sleve-dh}}[\textwidth]{\includegraphics[width=1.4in,angle=270]{data/gravityWaves-sleve-schaerExp-doubleHigh-h/18000/nonlinearMomentumZoom.eps}} \\
	\subcaptionbox{SnapCol DH \label{fig:gw:thetaDiffZoom:snapCol-dh}}[\textwidth]{\includegraphics[width=1.4in,angle=270]{data/gravityWaves-snapCol-schaerExp-doubleHigh-h/18000/nonlinearMomentumZoom.eps}} \\
%
