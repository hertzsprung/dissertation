...
\TODO{\textbf{coordinate transform theory}.  how relevant is this (since we're not transforming coords ourselves?)  Pielke 1984 has an excellent chapter on tensors, jacobian, Christoffel symbols...}

\TODO{\textbf{pressure gradient errors}.  explains the main problem with TF coords, motivates alternatives.  mesinger 1988 says this ISN'T a truncation error, others say it is (find citations).  review this.}
