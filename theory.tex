...
\begin{figure}
	...
	\captionsetup[subfigure]{position=b}
	\centering
	\subcaptionbox{\TODO{propagating} \label{fig:theory:gw:propagating}}[0.48\textwidth]{\input{gravityWaves-propagating-plot}}
	\hfill
	\subcaptionbox{\TODO{evanescent} \label{fig:theory:gw:evanescent}}[0.48\textwidth]{\input{gravityWaves-evanescent-plot}}
%
	\caption{\TODO{propagating and evanescent stationary waves}.  Adapted from \textcite{lynch-cassano2006}.}
