...
\begin{figure}
	...
	\captionsetup[subfigure]{position=b}
	\centering
	\subcaptionbox{\TODO{propagating} \label{fig:theory:gw:propagating}}{\TODO{}} \\
	\subcaptionbox{\TODO{evanescent} \label{fig:theory:gw:evanescent}}{\TODO{}}
%
	\caption{\TODO{propagating and evanescent stationary waves}}
	\label{fig:theory:gw:stationary-waves}
\end{figure}


\TODO{summarize what these two solutions mean physically, how ridge size relates to horizontal wavenumber, propagating/evanescent}
