...
The Courant--Friedrichs--Lewy criterion is a necessary condition for numerical stability (though it is not always, by itself, a sufficient condition).

\TODO{talk about courant number in 2D, give example of a long, thin rectangle with flux through it.  This will become relevant in gravityWaves results}
