...
plot 'data/gravityWaves-btf-schaerExp-h-exnerTheta.dat' using 2:1 axes x2y1 title 'BTF $\exner$' lt 1 lc 0, \
     'data/gravityWaves-snapCol-schaerExp-h-exnerTheta.dat' using 2:1 axes x2y1 title 'SnapCol $\exner$' lt 4 lc 0, \
     'data/gravityWaves-btf-schaerExp-h-exnerTheta.dat' using 3:1 title 'BTF $\theta$' lt 2 lc 0, \
     'data/gravityWaves-snapCol-schaerExp-h-exnerTheta.dat' using 3:1 title 'SnapCol $\theta$' lt 3 lc 0
