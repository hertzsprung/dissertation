...
The fully-compressible Euler equations used in the resting atmosphere test (section~\ref{sec:resting}) and gravity waves test (section~\ref{sec:gw}) are discretised following \textcite{weller2014}.  \TODO{describe the important bits!}
