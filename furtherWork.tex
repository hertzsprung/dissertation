...
In the horizontal advection test, we identified that divergence in the discrete velocity field on the BTF grid is a source of error in tracer magnitude in the region of vertical wind shear.  We propose a new test that would help quantify the error contribution due to divergence.  Here, the discrete velocity field should be made non-divergent by using Chorin's method to project onto a divergence-free space \autocite{chorin1968}.
