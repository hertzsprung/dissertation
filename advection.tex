...
Equation~\ref{eq:advection:continuous} is discretised by taking the volume integral over a cell $c$ with volume $V_c$
\begin{align}
...
%
\intertext{and the gradient ratio is specified in \textcite{weller2012} as}
%
...
Second, a TVD limited version of upwind-biased cubic scheme
...
\TODO{describe vanLeer and tvdLimitedCubicUpwindCPCFit}
...
BTF		& \input{openfoam/cases/advection/btf/schaerCos/vanLeer/l2error.txt}		& 0 \\
SLEVE		& \input{openfoam/cases/advection/sleve/schaerCos/vanLeer/l2error.txt}		& 0 \\
Cut cell	& \input{openfoam/cases/advection/snapCol/schaerCos/vanLeer/l2error.txt}	& 0 \\
\end{tabular}
