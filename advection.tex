...
\TODO{upwind-biased cubic scheme...}

The domain is discretised onto a grid having $300 \times 50$ cells such that $\Delta x = \SI{1}{\kilo\meter}$ and $\Delta \trans{z} = \SI{500}{\meter}$.  Unlike \textcite{schaer2002} which used periodic lateral boundaries, we use zero gradient boundary conditions for all boundaries. \TODO{set inlet to be fixedValue, not zeroGradient.  this will need some perl fu.}
...
\begin{figure}
	...
	\centering
	\subcaptionbox{BTF \label{fig:advection:cubicUpwindCPCFit:btf}}[0.49\textwidth]{\input{advection-btf-schaerCos-cubicUpwindCPCFit-contour-plot}}
	\hfill
...
\\
	\subcaptionbox{SLEVE \label{fig:advection:cubicUpwindCPCFit:sleve}}[0.49\textwidth]{\input{advection-sleve-schaerCos-cubicUpwindCPCFit-contour-plot}}
	\hfill
...
\\
	\subcaptionbox{Cut cell \label{fig:advection:cubicUpwindCPCFit:cutCell}}[0.49\textwidth]{\input{advection-snapCol-schaerCos-cubicUpwindCPCFit-contour-plot}}
	\hfill
	\subcaptionbox{Analytic solution on a regular grid}[0.49\textwidth]{\input{advection-noOrography-analytic-contour-plot}}
%
	\caption{\TODO{cubic upwind advection compared with schaer -- centred scheme.  Contour intervals every 0.1}}
	\label{fig:advection:cubicUpwind}
\end{figure}

\TODO{reanalyse the cubicUpwind results}
...
BTF		& \input{openfoam/cases/advection/btf/schaerCos/cubicUpwindCPCFit/l2error.txt}		\\
SLEVE		& \input{openfoam/cases/advection/sleve/schaerCos/cubicUpwindCPCFit/l2error.txt}	\\
Cut cell	& \input{openfoam/cases/advection/snapCol/schaerCos/cubicUpwindCPCFit/l2error.txt}	\\
