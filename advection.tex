...
\begin{figure}
	...
	\centering
	\subcaptionbox{BTF \label{fig:advection:vanLeer:btf}}[0.45\textwidth]{\input{advection-btf-schaerCos-vanLeer-contour-plot}}
	\hfill
	\subcaptionbox{BTF \label{fig:advection:schaer:btf}}[0.45\textwidth]{\includegraphics[height=1.2in]{img/schaer-btf-centred.png}}
\\
	\subcaptionbox{SLEVE \label{fig:advection:vanLeer:sleve}}[0.45\textwidth]{\TODO{}}
	\hfill
	\subcaptionbox{SLEVE \label{fig:advection:schaer:sleve}}[0.45\textwidth]{\includegraphics[height=1.2in]{img/schaer-sleve-centred.png}}
\\
	\subcaptionbox{Cut cell \label{fig:advection:vanLeer:cutCell}}[0.45\textwidth]{\input{advection-snapCol-schaerCos-vanLeer-contour-plot}}
	\hfill
	\subcaptionbox{???}[0.45\textwidth]{\TODO{}}
%
	\caption{\TODO{van Leer advection compared with schaer.  Contour intervals every 0.1}}
	\label{fig:advection:vanLeer}
\end{figure}

Results of advection using the van Leer scheme are presented in Figure~\ref{fig:advection:vanLeer}.  On the BTF grid, the tracer suffers from distortion over the mountain and has diffused significantly by the end of the simulation as evidenced by the missing contours in the centre of the tracer.

% cut cell same as noOrography.  both better than SLEVE, better than BTF
% tvdLimitedCubicUpwindCPCFit better than vanLeer
% compare with results from Schaer
% error norms at t=10000s
